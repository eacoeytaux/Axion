...
public:
    ...
    static Planc rPlanc( const Planc & high_bound, Distribution distribution = DEFAULT_DISTRIBUTION ) { return rPlanc( 0.0, high_bound, distribution ); }
    ...
    static Angle rAngle( const Angle & high_bound, Distribution distribution = DEFAULT_DISTRIBUTION ) { return rAngle( Angle( 0.0 ), high_bound, distribution ); }
