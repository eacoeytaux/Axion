...
public:
    ...
    Drawing & draw( const varray<Color> & colors, const Shape & shape, double thickness = FILLED, bool preserve_thickness = false );
    Drawing & draw( const Color & color, const Shape & shape, double thickness = FILLED, bool preserve_thickness = false );
...
private:
    ...
    Drawing & add_internal( const varray<Color> & colors, const Shape &, double thickness, bool preserve_thickness );
