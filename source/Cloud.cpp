...
Cloud::Cloud( World * world ) : Object( world )
{
    ...
    for_each( puff, small_puffs ) m_cloud_drawing.draw( OUTSIDE_COLOR, Shape::circle( puff.radius, puff.center_offset ), FILLED );
    for_each( puff, large_puffs ) m_cloud_drawing.draw( OUTSIDE_COLOR, Shape::circle( puff.radius, puff.center_offset ), FILLED );
    for_each( puff, large_puffs ) m_cloud_drawing.draw( INSIDE_COLOR, Shape::circle( puff.radius * PUFF_OUTLINE_RATIO, puff.center_offset ), FILLED );
}
