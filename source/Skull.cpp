...
Skull::Skull( World * world, const Coordinate & _position ) : Object( world, _position )
{
    ...
    m_skull_drawing.draw( BONE_COLOR, Shape::rectangle( JAW_WIDTH, JAW_HEIGHT, Coordinate( SKULL_RADIUS - half( JAW_WIDTH ), -half( JAW_HEIGHT ) ) ) );
    m_skull_drawing.draw( BONE_COLOR, Shape::circle( SKULL_RADIUS ) );

    m_skull_drawing.draw( HOLE_COLOR, Shape::circle( EYE_RADIUS, Coordinate( ( SKULL_RADIUS * EYE_OFFSET_X ) + ( SKULL_RADIUS * half( EYE_SPACING ) ), -( SKULL_RADIUS * EYE_OFFSET_Y ) ) ) );
    m_skull_drawing.draw( HOLE_COLOR, Shape::circle( EYE_RADIUS, Coordinate( ( SKULL_RADIUS * EYE_OFFSET_X ) - ( SKULL_RADIUS * half( EYE_SPACING ) ), -( SKULL_RADIUS * EYE_OFFSET_Y ) ) ) );
