...
error ogl::transform( const Transform & _transform )
{
    ...
    matrix[ 0 ] = _transform.get( 0, 0 );
    matrix[ 1 ] = _transform.get( 1, 0 );
    matrix[ 2 ] = _transform.get( 2, 0 );
    matrix[ 3 ] = 0.0;
    matrix[ 4 ] = _transform.get( 0, 1 );
    matrix[ 5 ] = _transform.get( 1, 1 );
    matrix[ 6 ] = _transform.get( 2, 1 );
    matrix[ 7 ] = 0.0;
    matrix[ 8 ] = _transform.get( 0, 2 );
    matrix[ 9 ] = _transform.get( 1, 2 );
    matrix[ 10 ] = _transform.get( 2, 2 );
    matrix[ 11 ] = 0.0;
    matrix[ 12 ] = 0.0;
    matrix[ 13 ] = 0.0;
    matrix[ 14 ] = 0.0;
...
error ogl::point_diameter( const double _d )
{
    glPointSize( _d );
    return check_errors( );
}
...
error ogl::line_width( const double _d )
{
    glLineWidth( _d );
    return check_errors( );
}
