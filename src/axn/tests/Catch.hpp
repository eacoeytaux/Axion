...
#define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION( ClassName, Name, Tags, ... ) \
    INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2(                                \
        ...
        INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ), ClassName, Name,     \
...
#define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE2( TestName, TestFuncName, Name, Tags,        \
...
#define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_2( TestNameClass, TestName, ClassName, Name,  \
                                                    Tags, Signature, ... )                     \
    CATCH_INTERNAL_START_WARNINGS_SUPPRESSION                                                  \
    CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS                                                   \
    CATCH_INTERNAL_SUPPRESS_ZERO_VARIADIC_WARNINGS                                             \
...
#define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD( ClassName, Name, Tags, ... )         \
    INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(                                        \
        INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ),                      \
        INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_ ), ClassName,   \
...
#ifndef CATCH_CONFIG_TRADITIONAL_MSVC_PREPROCESSOR
#define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG( ClassName, Name, Tags,           \
                                                              Signature, ... )                 \
    INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(                                        \
        INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ),                      \
        INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_ ), ClassName,   \
...
#define INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD_2( TestNameClass, TestName, ClassName,   \
                                                         Name, Tags, TmplList )                \
    CATCH_INTERNAL_START_WARNINGS_SUPPRESSION                                                  \
    CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS                                                   \
    CATCH_INTERNAL_SUPPRESS_UNUSED_TEMPLATE_WARNINGS                                           \
...
extern "C" int catch_main( int argc, wchar_t * argv[ ], wchar_t * [ ] )
{
    #else
...
#define CATCH_CAPTURE( ... )                                                                   \
    INTERNAL_CATCH_CAPTURE( INTERNAL_CATCH_UNIQUE_NAME( capturer ), "CATCH_CAPTURE",           \
                            __VA_ARGS__ )
...
#define CATCH_BENCHMARK_ADVANCED( name )                                                       \
    INTERNAL_CATCH_BENCHMARK_ADVANCED( INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_B_E_N_C_H_ ),     \
                                       name )
#endif // CATCH_CONFIG_ENABLE_BENCHMARKING
